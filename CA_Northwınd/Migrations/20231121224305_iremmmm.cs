...
{
    /// <inheritdoc />
    public partial class iremmmm : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitStock = table.Column<short>(type: "smallint", nullable: true),
                    CategoryId = table.Column<int>(type: "int", nullable: false),
                    SupplierId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.InsertData(
                table: "Suppliers",
                columns: new[] { "SupplierId", "Address", "CompanyName", "ContactName", "ContactTitle" },
                values: new object[] { 1, "d marka", "A marka", "B marka", "c marka" });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "ProductName", "SupplierId", "UnitPrice", "UnitStock" },
                values: new object[,]
                {
                    { 1, 1, "Tofu", 1, 23.2500m, (short)35 },
                    { 2, 2, "Mascarpone Fabioli", 1, 32.0000m, (short)9 }
                });
